package com.system.demo.bulk.volunteer.volunteerupadate.listener;
...
@Component
@AllArgsConstructor
public class VolunteerUpdateJobNotificationListener extends JobExecutionListenerSupport {
    @Autowired
